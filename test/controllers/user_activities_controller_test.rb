...
class UserActivitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_activity" do
    assert_difference('UserActivity.count') do
      post user_activities_url, params: { user_activity: { activity_id: @user_activity.activity_id, status: @user_activity.status, user_id: @user_activity.user_id } }
    end
  ...
  test "should update user_activity" do
    patch user_activity_url(@user_activity), params: { user_activity: { activity_id: @user_activity.activity_id, status: @user_activity.status, user_id: @user_activity.user_id } }
